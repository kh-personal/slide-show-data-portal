...
#### Scenario: Legend uses a single column

- **WHEN** a donut chart renders its legend
- **THEN** each legend entry occupies one row in a single-column list with a color swatch, label, and numeric value
